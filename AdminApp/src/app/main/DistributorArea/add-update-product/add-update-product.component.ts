...
export class AddUpdateProductComponent implements OnInit {
  ...
  private prepareProduct(): ProductDto {
    ...
    productResponse.distributorId = Number(localStorage.getItem("CurrenUserId"));
    ...
    productResponse.productUserId = null;
    ...
    this._productService.save(_input).subscribe(res => {
      ...
      swal.fire({
        ...
        .then((result) => {
          ...
          if (result.value) {
            this.router.navigate(['../main/DistributorArea/product']);
